...
namespace WcfServiceRegistrasiVaksin_20
{
    ...
    public class Service1 : IService1
    {
        public void DeleteVaksin(string id)
        {
            ...
            var d = (from VaksinData in va.VaksinDatas
                     where VaksinData.no_register == id
                     select VaksinData).First();
        ...
        {
            VaksinContext va = new VaksinContext();
            var u = (from VaksinData in va.VaksinDatas
                     where VaksinData.no_register == obj.no_register
                     select VaksinData).First();
